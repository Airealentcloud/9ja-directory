    ...
    (
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div style={{ fontSize: 56, fontWeight: 800, letterSpacing: -1 }}>9jaDirectory</div>
          <div style={{ fontSize: 30, fontWeight: 600, maxWidth: 900, lineHeight: 1.2 }}>
        ...
        <div style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', opacity: 0.9 }}>
          <div style={{ fontSize: 20 }}>9jadirectory.org</div>
          <div style={{ fontSize: 20 }}>Nigeria Business Directory</div>
        </div>
      </div>
    ),
    size
